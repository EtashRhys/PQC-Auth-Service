...
- **GitHub Security Advisory** (recommended):  
  Go to the [Security tab](https://github.com/EtashRhys/PQC-Auth-Service/security/advisories) → "Report a vulnerability"
...
- This project is **experimental research code** — it is **not** intended for production use yet.
